...
user2 = User.new(name: "Augusto", email: "augusto@dev.com", password: "123456", confirmed_at: Time.now)
...
recipeFood2 = RecipeFood.create(quantity: 3, recipe_id: recipe.id, food_id: food2.id)
recipeFood3 = RecipeFood.create(quantity: 1, recipe_id: recipe2.id, food_id: food2.id)
recipeFood4 = RecipeFood.create(quantity: 5, recipe_id: recipe3.id, food_id: food3.id)
recipeFood5 = RecipeFood.create(quantity: 6, recipe_id: recipe3.id, food_id: food4.id)
